...
import 'package:ngdemo14_again/services/log_service.dart';
import 'package:ngdemo14_again/services/prefs_service.dart';
...
class FileService{
   ...
   static Future<String> uploadPostImage(File _image) async{
      ...
      FirebaseStorage _storage = FirebaseStorage.instanceFor(app:app, bucket: 'ngdemo14again.appspot.com');
